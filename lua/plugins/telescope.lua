return {
	...
	config = function()
		...
		map("n", "<C-p>", builtin.find_files, opts) -- Lists files in your current working directory, respects .gitignore
		...
		map("n", "<leader>fg", builtin.live_grep, opts) -- Live grep across all files
	end,
}
